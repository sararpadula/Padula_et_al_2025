...
head(mochBreed)
quadM1 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + Female.Wing.Chord2 + (1|FemaleBander) + (1|MaleBander) + (1|Year), data = mochBreed)
quadM2 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + Female.Wing.Chord2 + (1|FemaleBander) + (1|MaleBander), data = mochBreed)

anova(quadM1, quadM2, test = "F") #quadM2 has a lower AIC score
...
head(mochBreed)
lmM1 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + (1|FemaleBander) + (1|MaleBander) + (1|Year), data = mochBreed)
lmM2 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + (1|FemaleBander) + (1|MaleBander), data = mochBreed)


anova(lmM1, lmM2, test = "F") #lmM2 has a lower AIC score
...
nullMoch <- lmer(Male.Wing.Chord ~ 1 + (1|FemaleBander) + (1|MaleBander), data = mochBreed)

anova(quadM2,lmM2) #lmM2 has a lower AIC score
...
#which quadratic model is the best?
head(bcchBreed)
quadB1 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + Female.Wing.Chord2 + (1|FemaleBander) + (1|MaleBander) + (1|Year), data = bcchBreed)
quadB2 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + Female.Wing.Chord2 + (1|FemaleBander) + (1|MaleBander), data = bcchBreed)

anova(quadB1, quadB2, test = "F") #quadB2 has a lower AIC score
...
#which linear model is the best?
head(bcchBreed)
lmB1 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + (1|FemaleBander) + (1|MaleBander) + (1|Year), data = bcchBreed)
lmB2 <- lmer(Male.Wing.Chord ~ Female.Wing.Chord + (1|FemaleBander) + (1|MaleBander), data = bcchBreed)


anova(lmB1, lmB2, test = "F") #lmB2 has a lower AIC score

summary(lmB2)

nullBcch <- lmer(Male.Wing.Chord ~ (1|FemaleBander) + (1|MaleBander), data = bcchBreed)


AIC(quadB2,lmB2) 

#quadratic has a higher AIC score but not high enough to justify doing the more complex model (301 vs 296)
